...
export default function FundRoundScreen({ route }) {
        ...
        <VStack space={1}>
          <Box bg="white" roundedTop="xl" roundedBottom="md">
            ...
            <HStack px={5} justifyContent="space-between">
              <Text mt={1}>Balance: {(balances[tokenAddrs[1]] * 1).toFixed(2)} USxD</Text>
              <Pressable
                bg="primary.100"
                px={2}
                py={1}
          ...
          >
            ...
            <Text fontSize="md">{dueAmount} USxD</Text>
          </HStack>
        </VStack>
      </VStack>
      <Spacer />
